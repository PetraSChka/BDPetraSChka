...
--INSERT MATCHES
INSERT INTO MATCHES(SEASON_ID, FIRST_TEAM_NAME, SECOND_TEAM_NAME, DATE_OF_MATCH, AVG_PRICE, TICKETS_SOLD, STADIUM_ID)
SELECT DISTINCT S.SEASON_ID, dt.TEAM_1, dt.TEAM_2, dt.DATE_TIME, dt.AVG_PRICE, dt.TICKETS_SOLD, ST.STADIUM_ID
FROM DATA_TABLE dt
LEFT JOIN SEASONS S ON dt.CHAMPIONSHIP = S.SEASON_YEAR
LEFT JOIN STADIUMS ST ON dt.VENUE=ST.NAME;
